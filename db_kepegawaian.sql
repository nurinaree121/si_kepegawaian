...
--
-- Host: localhost:3306
-- Generation Time: May 20, 2024 at 10:44 AM
...
CREATE TABLE `ijin` (
  `id_ijin` varchar(255) NOT NULL,
  `id_pegawai` varchar(255) NOT NULL,
  `tgl_ijin` date NOT NULL,
  `keterangan_ijin` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
('VP0KX1lG9Ktajv7IvI9wvdKc2gOO86HbpuLHkDBA', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Safari/537.36', 'YTozOntzOjY6Il90b2tlbiI7czo0MDoiWTJKVjhsVzVxV2dXZWs0NFZOUWllNVR5UElPc2dtSFdCaGNJalNIaCI7czo5OiJfcHJldmlvdXMiO2E6MTp7czozOiJ1cmwiO3M6MjE6Imh0dHA6Ly8xMjcuMC4wLjE6ODAwMCI7fXM6NjoiX2ZsYXNoIjthOjI6e3M6Mzoib2xkIjthOjA6e31zOjM6Im5ldyI7YTowOnt9fX0=', 1715351498);
...
CREATE TABLE `tunjangan_pegawai` (
  `id_tunjangan` varchar(255) NOT NULL,
  `id_pegawai` varchar(255) NOT NULL,
...
--
ALTER TABLE `ijin`
  ADD CONSTRAINT `ijin_ibfk_1` FOREIGN KEY (`id_pegawai`) REFERENCES `pegawai` (`id_pegawai`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `tunjangan_pegawai`
  ADD CONSTRAINT `tunjangan_pegawai_ibfk_1` FOREIGN KEY (`id_pegawai`) REFERENCES `pegawai` (`id_pegawai`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
